...
import net.lingala.zip4j.callback.UncatchException;
...
public class ZipFile {
    ...
    public void extractAll(String destinationPath, UncatchException uncatchException) throws ZipException {
        ...
        new ExtractAllFilesTask(progressMonitor, runInThread, zipModel, password).execute(
                new ExtractAllFilesTaskParameters(destinationPath),uncatchException);
    }
